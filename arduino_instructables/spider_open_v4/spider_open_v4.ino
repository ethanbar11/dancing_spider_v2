...
/*
  ...
  ETHAN : This function sets the desired location + speed, doesn't
  preform it (another function does).
   ---------------------------------------------------------------------------*/
void set_site(int leg, float x, float y, float z)
{
  // ETHAN: The lengths are how many distance of axis the leg should move.
  // ETHAN: Calculating it for speed usage.
  float length_x = 0, length_y = 0, length_z = 0;
  // ETHAN: Keep is 255, meaning stay in place.
  if (x != KEEP)
